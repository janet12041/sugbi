...
var len__5769__auto___78051 = arguments.length;
var i__5770__auto___78052 = (0);
while(true){
if((i__5770__auto___78052 < len__5769__auto___78051)){
args__5775__auto__.push((arguments[i__5770__auto___78052]));

var G__78053 = (i__5770__auto___78052 + (1));
i__5770__auto___78052 = G__78053;
continue;
} else {
}
break;
...
/** @this {Function} */
(markdown.common.freeze_string.cljs$lang$applyTo = (function (seq78002){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq78002));
}));
...
var G__78054 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__5802__auto__){
return (function (s,r){
return clojure.string.replace(s,cljs.core.re_pattern(r),((function (text,state,matches,temp__5802__auto__){
return (function (p1__78010_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__78010_SHARP_,p1__78010_SHARP_);
});})(text,state,matches,temp__5802__auto__))
);
});})(text,state,matches,temp__5802__auto__))
,text,matches);
var G__78055 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5802__auto__){
return (function (p1__78011_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__78011_SHARP_,matches);
});})(text,state,matches,temp__5802__auto__))
);
text = G__78054;
state = G__78055;
...
var vec__78041 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__78044 = (function (){var G__78047 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(buf);
var G__78048 = cur_state;
return (transformer.cljs$core$IFn$_invoke$arity$2 ? transformer.cljs$core$IFn$_invoke$arity$2(G__78047,G__78048) : transformer.call(null,G__78047,G__78048));
})();
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78044,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78044,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.seq(s),new_state], null);
})());
var new_buf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78041,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78041,(1),null);
var G__78058 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__78059 = cljs.core.PersistentVector.EMPTY;
var G__78060 = cljs.core.rest(tokens);
var G__78061 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__78058;
buf = G__78059;
tokens = G__78060;
cur_state = G__78061;
...
var G__78062 = out;
var G__78063 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__78064 = cljs.core.rest(tokens);
var G__78065 = cur_state;
out = G__78062;
buf = G__78063;
tokens = G__78064;
cur_state = G__78065;
...
var G__78066 = out;
var G__78067 = buf;
var G__78068 = cljs.core.rest(tokens);
var G__78069 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__78066;
buf = G__78067;
tokens = G__78068;
cur_state = G__78069;
...
var G__78070 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__78071 = buf;
var G__78072 = cljs.core.rest(tokens);
var G__78073 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911),markdown.common.open_html_tags(new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911).cljs$core$IFn$_invoke$arity$1(cur_state),cljs.core.first(tokens)));
out = G__78070;
buf = G__78071;
tokens = G__78072;
cur_state = G__78073;
...
var num_hashes = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__78049_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__78049_SHARP_);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__78050_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",p1__78050_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__78050_SHARP_)));
}),cljs.core.seq(text))));
if((num_hashes > (0))){
return num_hashes;
} else {
