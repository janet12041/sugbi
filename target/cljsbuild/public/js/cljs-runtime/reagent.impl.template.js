...
var G__66312 = o;
reagent.impl.template.goog$module$goog$object.set(G__66312,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__66336__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__66336 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__66337__i = 0, G__66337__a = new Array(arguments.length -  0);
while (G__66337__i < G__66337__a.length) {G__66337__a[G__66337__i] = arguments[G__66337__i + 0]; ++G__66337__i;}
  args = new cljs.core.IndexedSeq(G__66337__a,0,null);
} 
return G__66336__delegate.call(this,args);};
G__66336.cljs$lang$maxFixedArity = 0;
G__66336.cljs$lang$applyTo = (function (arglist__66338){
var args = cljs.core.seq(arglist__66338);
return G__66336__delegate(args);
});
G__66336.cljs$core$IFn$_invoke$arity$variadic = G__66336__delegate;
return G__66336;
})()
;
} else {
...
var G__66314 = o;
reagent.impl.template.goog$module$goog$object.set(G__66314,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__66340__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__66340 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__66341__i = 0, G__66341__a = new Array(arguments.length -  0);
while (G__66341__i < G__66341__a.length) {G__66341__a[G__66341__i] = arguments[G__66341__i + 0]; ++G__66341__i;}
  args = new cljs.core.IndexedSeq(G__66341__a,0,null);
} 
return G__66340__delegate.call(this,args);};
G__66340.cljs$lang$maxFixedArity = 0;
G__66340.cljs$lang$applyTo = (function (arglist__66342){
var args = cljs.core.seq(arglist__66342);
return G__66340__delegate(args);
});
G__66340.cljs$core$IFn$_invoke$arity$variadic = G__66340__delegate;
return G__66340;
})()
;
} else {
...
var G__66315 = props;
var G__66315__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__66315,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__66315);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__66315__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__66316 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__66316,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__66316;
}
})(),id_class);
...
var G__66317 = (cljs.core.count(argv) - first_child);
switch (G__66317) {
case (0):
...
var vec__66318 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66318,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66318,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66318,(2),null);
...
var temp__5808__auto___66344 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___66344 == null)){
} else {
var key_66345 = temp__5808__auto___66344;
(jsprops.key = key_66345);
}
...
var temp__5808__auto___66346 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___66346 == null)){
} else {
var key_66347 = temp__5808__auto___66346;
(jsprops.key = key_66347);
}
...
var temp__5808__auto___66350 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___66350 == null)){
} else {
var key_66351 = temp__5808__auto___66350;
(jsprops.key = key_66351);
}
...
var temp__5808__auto___66352 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___66352 == null)){
} else {
var key_66353 = temp__5808__auto___66352;
(jsprops.key = key_66353);
}
...
var temp__5808__auto___66354 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___66354 == null)){
} else {
var key_66355 = temp__5808__auto___66354;
(jsprops.key = key_66355);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66321_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__66321_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__66322 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66322,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66322,(1),null);
...
break;
default:
var G__66359 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__66360 = compiler;
v = G__66359;
compiler = G__66360;
continue;
...
var G__66326 = tag;
var G__66326__$1 = (((G__66326 instanceof cljs.core.Keyword))?G__66326.fqn:null);
switch (G__66326__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template66328 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template66328 = (function (opts,id,fn_to_element,parse_fn,meta66329){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta66329 = meta66329;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template66328.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_66330,meta66329__$1){
var self__ = this;
var _66330__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template66328(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta66329__$1));
}));

(reagent.impl.template.t_reagent$impl$template66328.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_66330){
var self__ = this;
var _66330__$1 = this;
return self__.meta66329;
}));

(reagent.impl.template.t_reagent$impl$template66328.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template66328.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template66328.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template66328.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template66328.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template66328.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta66329","meta66329",623529039,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template66328.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template66328.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template66328");

(reagent.impl.template.t_reagent$impl$template66328.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template66328");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template66328.
 */
reagent.impl.template.__GT_t_reagent$impl$template66328 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template66328(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta66329){
return (new reagent.impl.template.t_reagent$impl$template66328(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta66329));
});

}

return (new reagent.impl.template.t_reagent$impl$template66328(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
