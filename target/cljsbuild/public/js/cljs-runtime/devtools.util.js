...
var len__5769__auto___64973 = arguments.length;
var i__5770__auto___64974 = (0);
while(true){
if((i__5770__auto___64974 < len__5769__auto___64973)){
args__5775__auto__.push((arguments[i__5770__auto___64974]));

var G__64975 = (i__5770__auto___64974 + (1));
i__5770__auto___64974 = G__64975;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__64913_64976 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64914_64977 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64915_64978 = true;
var _STAR_print_fn_STAR__temp_val__64916_64979 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64915_64978);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64916_64979);

try{var _STAR_print_level_STAR__orig_val__64917_64980 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__64918_64981 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__64918_64981);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__64917_64980);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64914_64977);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64913_64976);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq64912){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq64912));
}));
...
var new_formatters = current_formatters.filter((function (p1__64948_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__64948_SHARP_)));
}));
...
var G__64950_64989 = f;
var target__62956__auto___64990 = G__64950_64989;
if(cljs.core.truth_(target__62956__auto___64990)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64950_64989)].join(''),"\n","target__62956__auto__"].join('')));
}

(target__62956__auto___64990["toString"] = (function (){
...
var G__64951_64991 = "%c%s";
var G__64952_64992 = "color:transparent";
var G__64953_64993 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__64951_64991,G__64952_64992,G__64953_64993) : f.call(null,G__64951_64991,G__64952_64992,G__64953_64993));
...
var args__5775__auto__ = [];
var len__5769__auto___64995 = arguments.length;
var i__5770__auto___64996 = (0);
while(true){
if((i__5770__auto___64996 < len__5769__auto___64995)){
args__5775__auto__.push((arguments[i__5770__auto___64996]));

var G__64997 = (i__5770__auto___64996 + (1));
i__5770__auto___64996 = G__64997;
continue;
} else {
}
break;
...
var vec__64960 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64960,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64960,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__64998__delegate = function (add_fmt,add_args){
...
var G__64998 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__64999__i = 0, G__64999__a = new Array(arguments.length -  1);
while (G__64999__i < G__64999__a.length) {G__64999__a[G__64999__i] = arguments[G__64999__i + 1]; ++G__64999__i;}
  add_args = new cljs.core.IndexedSeq(G__64999__a,0,null);
} 
return G__64998__delegate.call(this,add_fmt,add_args);};
G__64998.cljs$lang$maxFixedArity = 1;
G__64998.cljs$lang$applyTo = (function (arglist__65000){
var add_fmt = cljs.core.first(arglist__65000);
var add_args = cljs.core.rest(arglist__65000);
return G__64998__delegate(add_fmt,add_args);
});
G__64998.cljs$core$IFn$_invoke$arity$variadic = G__64998__delegate;
return G__64998;
})()
);
}));
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq64956){
var G__64957 = cljs.core.first(seq64956);
var seq64956__$1 = cljs.core.next(seq64956);
var G__64958 = cljs.core.first(seq64956__$1);
var seq64956__$2 = cljs.core.next(seq64956__$1);
var G__64959 = cljs.core.first(seq64956__$2);
var seq64956__$3 = cljs.core.next(seq64956__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64957,G__64958,G__64959,seq64956__$3);
}));
...
var seq__64964 = cljs.core.seq(features);
var chunk__64965 = null;
var count__64966 = (0);
var i__64967 = (0);
while(true){
if((i__64967 < count__64966)){
var feature = chunk__64965.cljs$core$IIndexed$_nth$arity$2(null,i__64967);
...
var G__65002 = seq__64964;
var G__65003 = chunk__64965;
var G__65004 = count__64966;
var G__65005 = (i__64967 + (1));
seq__64964 = G__65002;
chunk__64965 = G__65003;
count__64966 = G__65004;
i__64967 = G__65005;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__64964);
if(temp__5804__auto__){
var seq__64964__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__64964__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__64964__$1);
var G__65006 = cljs.core.chunk_rest(seq__64964__$1);
var G__65007 = c__5568__auto__;
var G__65008 = cljs.core.count(c__5568__auto__);
var G__65009 = (0);
seq__64964 = G__65006;
chunk__64965 = G__65007;
count__64966 = G__65008;
i__64967 = G__65009;
continue;
} else {
var feature = cljs.core.first(seq__64964__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__65010 = cljs.core.next(seq__64964__$1);
var G__65011 = null;
var G__65012 = (0);
var G__65013 = (0);
seq__64964 = G__65010;
chunk__64965 = G__65011;
count__64966 = G__65012;
i__64967 = G__65013;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o64972 = temp__5802__auto__;
return (o64972["version"]);
} else {
return null;
}
})() == null);
