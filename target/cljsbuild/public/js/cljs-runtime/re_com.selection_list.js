...
var G__71175_71517 = re_com.selection_list.check_clicked(selections,item_id,cljs.core.not((selections.cljs$core$IFn$_invoke$arity$1 ? selections.cljs$core$IFn$_invoke$arity$1(item_id) : selections.call(null,item_id))),required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__71175_71517) : on_change.call(null,G__71175_71517));
}
...
var G__71179_71519 = re_com.selection_list.radio_clicked(selections,item_id,required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__71179_71519) : on_change.call(null,G__71179_71519));
}
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__71449){
var map__71450 = p__71449;
var map__71450__$1 = cljs.core.__destructure_map(map__71450);
var args = map__71450__$1;
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"model","model",331153215));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var multi_select_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71450__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_(item_renderer)?(function (p1__71445_SHARP_){
return (item_renderer.cljs$core$IFn$_invoke$arity$8 ? item_renderer.cljs$core$IFn$_invoke$arity$8(p1__71445_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_) : item_renderer.call(null,p1__71445_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_));
}):(cljs.core.truth_(multi_select_QMARK_)?(function (p1__71446_SHARP_){
return re_com.selection_list.as_checked(p1__71446_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
}):(function (p1__71447_SHARP_){
return re_com.selection_list.as_radio(p1__71447_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
}))),choices);
...
var len__5769__auto___71571 = arguments.length;
var i__5770__auto___71572 = (0);
while(true){
if((i__5770__auto___71572 < len__5769__auto___71571)){
args__5775__auto__.push((arguments[i__5770__auto___71572]));

var G__71573 = (i__5770__auto___71572 + (1));
i__5770__auto___71572 = G__71573;
continue;
} else {
}
break;
...
(re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__71490){
var map__71499 = p__71490;
var map__71499__$1 = cljs.core.__destructure_map(map__71499);
var args = map__71499__$1;
if((((!(goog.DEBUG)))?true:re_com.validate.validate_args.cljs$core$IFn$_invoke$arity$variadic(re_com.validate.extract_arg_data(re_com.selection_list.selection_list_args_desc),args,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["selection-list"], 0)))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}
...
return (function() { 
var G__71574__delegate = function (p__71507){
var map__71508 = p__71507;
var map__71508__$1 = cljs.core.__destructure_map(map__71508);
var args__$1 = map__71508__$1;
...
while (G__71575__i < G__71575__a.length) {G__71575__a[G__71575__i] = arguments[G__71575__i + 0]; ++G__71575__i;}
  p__71507 = new cljs.core.IndexedSeq(G__71575__a,0,null);
} 
return G__71574__delegate.call(this,p__71507);};
G__71574.cljs$lang$maxFixedArity = 0;
G__71574.cljs$lang$applyTo = (function (arglist__71576){
var p__71507 = cljs.core.seq(arglist__71576);
return G__71574__delegate(p__71507);
});
...
/** @this {Function} */
(re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq71487){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq71487));
}));
