...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function markdown$lists$close_lists_$_iter__78261(s__78262){
return (new cljs.core.LazySeq(null,(function (){
var s__78262__$1 = s__78262;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__78262__$1);
if(temp__5804__auto__){
var s__78262__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__78262__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__78262__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__78264 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__78263 = (0);
while(true){
if((i__78263 < size__5522__auto__)){
var vec__78265 = cljs.core._nth(c__5521__auto__,i__78263);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78265,(0),null);
cljs.core.chunk_append(b__78264,["</li></",cljs.core.name(list_type),">"].join(''));

var G__78284 = (i__78263 + (1));
i__78263 = G__78284;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__78264),markdown$lists$close_lists_$_iter__78261(cljs.core.chunk_rest(s__78262__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__78264),null);
}
} else {
var vec__78268 = cljs.core.first(s__78262__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78268,(0),null);
return cljs.core.cons(["</li></",cljs.core.name(list_type),">"].join(''),markdown$lists$close_lists_$_iter__78261(cljs.core.rest(s__78262__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__78271_SHARP_){
return (cljs.core.second(p1__78271_SHARP_) > num_indents);
...
var vec__78273 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78273,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78273,(1),null);
...
var vec__78277 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78277,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78277,(1),null);
var num_indents = cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_," "),text));
...
markdown.lists.li = (function markdown$lists$li(text,p__78281){
var map__78282 = p__78281;
var map__78282__$1 = cljs.core.__destructure_map(map__78282);
var state = map__78282__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78282__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78282__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78282__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78282__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
