...
var trimmed = (function (){var G__78524 = text;
if((G__78524 == null)){
return null;
} else {
return clojure.string.trim(G__78524);
}
})();
...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__78525){
var map__78526 = p__78525;
var map__78526__$1 = cljs.core.__destructure_map(map__78526);
var state = map__78526__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78526__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78526__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
var G__78577 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq("<sup>"),cljs.core.second(remaining),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.seq("</sup>")], 0)));
var G__78578 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),remaining);
buf = G__78577;
remaining = G__78578;
continue;
} else {
var G__78579 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(remaining));
var G__78580 = cljs.core.rest(remaining);
buf = G__78579;
remaining = G__78580;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__78527){
var map__78528 = p__78527;
var map__78528__$1 = cljs.core.__destructure_map(map__78528);
var state = map__78528__$1;
var buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78528__$1,new cljs.core.Keyword(null,"buf","buf",-213913340));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78528__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78528__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78528__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var heading_anchors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78528__$1,new cljs.core.Keyword(null,"heading-anchors","heading-anchors",1713527866));
...
markdown.transformers.br = (function markdown$transformers$br(text,p__78529){
var map__78530 = p__78529;
var map__78530__$1 = cljs.core.__destructure_map(map__78530);
var state = map__78530__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78530__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78530__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__78532){
var map__78533 = p__78532;
var map__78533__$1 = cljs.core.__destructure_map(map__78533);
var state = map__78533__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78533__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var frozen_strings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78533__$1,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace(text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__78531_SHARP_){
var vec__78534 = markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__78531_SHARP_,(1),(cljs.core.count(p1__78531_SHARP_) - (1))),cljs.core.deref(currently_frozen)], 0));
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78534,(0),null);
var frozen_strings__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78534,(1),null);
...
return ["0",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__78538)].join('');
} else {
return G__78538;
}
});
...
})())?text:clojure.string.replace(text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__78537_SHARP_){
var encoded = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2(encoder,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__78537_SHARP_,(1),(cljs.core.count(p1__78537_SHARP_) - (1)))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__78539){
var map__78540 = p__78539;
var map__78540__$1 = cljs.core.__destructure_map(map__78540);
var state = map__78540__$1;
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78540__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__78541){
var map__78542 = p__78541;
var map__78542__$1 = cljs.core.__destructure_map(map__78542);
var state = map__78542__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78542__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78542__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78542__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78542__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78542__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78542__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78542__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78542__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78542__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78542__$1,new cljs.core.Keyword(null,"code","code",1586293142));
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__78543){
var map__78544 = p__78543;
var map__78544__$1 = cljs.core.__destructure_map(map__78544);
var state = map__78544__$1;
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78544__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78544__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
if(cljs.core.truth_((function (){var and__5043__auto__ = paragraph;
if(cljs.core.truth_(and__5043__auto__)){
var G__78545 = next_line;
var G__78545__$1 = (((G__78545 == null))?null:clojure.string.trim(G__78545));
if((G__78545__$1 == null)){
return null;
} else {
return clojure.string.ends_with_QMARK_(G__78545__$1,"```");
}
} else {
return and__5043__auto__;
}
...
markdown.transformers.code = (function markdown$transformers$code(text,p__78546){
var map__78547 = p__78546;
var map__78547__$1 = cljs.core.__destructure_map(map__78547);
var state = map__78547__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78547__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var indent_code_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78547__$1,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78547__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78547__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78547__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78547__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78547__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
...
if(cljs.core.truth_(code)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [[markdown.common.escape_code(clojure.string.replace_first(text,/    /,"\n")),(cljs.core.truth_(should_close_QMARK_)?"</code></pre>":null)].join(''),(function (){var G__78548 = state;
if(cljs.core.truth_(should_close_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__78548,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061),true);
} else {
return G__78548;
}
})()], null);
...
if((num_spaces >= (4))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["<pre><code>",markdown.common.escape_code(clojure.string.replace_first(text,/    /,"")),(cljs.core.truth_(should_close_QMARK_)?"</code></pre>":null)].join(''),(function (){var G__78549 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"code","code",1586293142),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"indented-code","indented-code",-904930175),true], 0));
if(cljs.core.truth_(should_close_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__78549,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061),true);
} else {
return G__78549;
}
})()], null);
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__78550){
var map__78551 = p__78550;
var map__78551__$1 = cljs.core.__destructure_map(map__78551);
var state = map__78551__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78551__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var codeblock_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78551__$1,new cljs.core.Keyword(null,"codeblock-end","codeblock-end",1507794736));
var indented_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78551__$1,new cljs.core.Keyword(null,"indented-code","indented-code",-904930175));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78551__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78551__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim(text);
var next_line_closes_QMARK_ = (function (){var G__78552 = next_line;
var G__78552__$1 = (((G__78552 == null))?null:clojure.string.trim(G__78552));
if((G__78552__$1 == null)){
return null;
} else {
return clojure.string.ends_with_QMARK_(G__78552__$1,"```");
}
})();
...
var vec__78553 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,"\n"),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((3),trimmed));
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78553,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78553,(1),null);
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__78556){
var map__78557 = p__78556;
var map__78557__$1 = cljs.core.__destructure_map(map__78557);
var state = map__78557__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78557__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78557__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78557__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var trimmed = clojure.string.trim(text);
if(cljs.core.truth_((function (){var or__5045__auto__ = code;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__78558){
var map__78559 = p__78558;
var map__78559__$1 = cljs.core.__destructure_map(map__78559);
var state = map__78559__$1;
var blockquote_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78559__$1,new cljs.core.Keyword(null,"blockquote-start","blockquote-start",276074935));
var blockquote_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78559__$1,new cljs.core.Keyword(null,"blockquote-end","blockquote-end",1122544964));
var blockquote_paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78559__$1,new cljs.core.Keyword(null,"blockquote-paragraph","blockquote-paragraph",1931783682));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78559__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
return (function (p1__78560_SHARP_){
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__78560_SHARP_),"</ol>"].join('');
})(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (footnotes__$1,p__78561){
var vec__78562 = p__78561;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78562,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78562,(1),null);
...
var vec__78565 = cljs.core.re_matches(/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78565,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78565,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78565,(2),null);
var vec__78568 = cljs.core.re_matches(/^    (.*)$/,line);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78568,(0),null);
var next_val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78568,(1),null);
...
var vec__78574 = ((cljs.core.sequential_QMARK_(data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78574,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78574,(1),null);
...
var G__78614 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val])], 0));
var G__78615 = cljs.core.rest(remain);
var G__78616 = key;
acc = G__78614;
remain = G__78615;
prev_key = G__78616;
