...
var i_70862 = (0);
while(true){
if((i_70862 < arr.length)){
(arr[i_70862] = null);

var G__70864 = (i_70862 + (1));
i_70862 = G__70864;
continue;
} else {
}
...
var i_70871 = (self__.level + (1));
while(true){
if((i_70871 <= (new_level + (1)))){
(update[i_70871] = self__.header);

var G__70872 = (i_70871 + (1));
i_70871 = G__70872;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_70873 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_70873[i]));
} else {
x__$2.forward.push((((i < links_70873.length))?(links_70873[i]):null));
}

if((i < links_70873.length)){
(links_70873[i] = x__$2);
} else {
links_70873.push(x__$2);
}
...
var i_70875 = (0);
while(true){
if((i_70875 <= self__.level)){
var links_70876 = (update[i_70875]).forward;
if((x__$1 === (((i_70875 < links_70876.length))?(links_70876[i_70875]):null))){
(links_70876[i_70875] = (x__$1.forward[i_70875]));

var G__70877 = (i_70875 + (1));
i_70875 = G__70877;
continue;
} else {
var G__70878 = (i_70875 + (1));
i_70875 = G__70878;
continue;
}
} else {
...
var G__70880 = nx;
var G__70881 = (level__$1 - (1));
x = G__70880;
level__$1 = G__70881;
continue;
} else {
var G__70882 = x;
var G__70883 = (level__$1 - (1));
x = G__70882;
level__$1 = G__70883;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__70885 = nx;
var G__70886 = (level__$1 - (1));
x = G__70885;
level__$1 = G__70886;
continue;
} else {
var G__70887 = x;
var G__70888 = (level__$1 - (1));
x = G__70887;
level__$1 = G__70888;
continue;
}
