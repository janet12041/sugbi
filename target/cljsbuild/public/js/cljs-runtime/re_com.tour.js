...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__71645_SHARP_,p2__71646_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__71645_SHARP_,p2__71646_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function re_com$tour$initialise_tour_$_iter__71674(s__71675){
return (new cljs.core.LazySeq(null,(function (){
var s__71675__$1 = s__71675;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__71675__$1);
if(temp__5804__auto__){
var s__71675__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__71675__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__71675__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__71677 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__71676 = (0);
while(true){
if((i__71676 < size__5522__auto__)){
var step = cljs.core._nth(c__5521__auto__,i__71676);
cljs.core.chunk_append(b__71677,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__71726 = (i__71676 + (1));
i__71676 = G__71726;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__71677),re_com$tour$initialise_tour_$_iter__71674(cljs.core.chunk_rest(s__71675__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__71677),null);
}
} else {
var step = cljs.core.first(s__71675__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__71674(cljs.core.rest(s__71675__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__71681 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__71681.cljs$core$IFn$_invoke$arity$1 ? fexpr__71681.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__71681.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__71719 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__71719.cljs$core$IFn$_invoke$arity$1 ? fexpr__71719.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__71719.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__71720 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__71720.cljs$core$IFn$_invoke$arity$1 ? fexpr__71720.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__71720.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__71721 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__71721.cljs$core$IFn$_invoke$arity$1 ? fexpr__71721.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__71721.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__71722 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__71722.cljs$core$IFn$_invoke$arity$1 ? fexpr__71722.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__71722.call(null,tour));
})(),true);
} else {
return null;
}
