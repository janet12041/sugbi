...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_77283 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_77283(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_77284 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_77284(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_77285 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_77285(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_77286 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_77286(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_77287 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_77287(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_77293 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_77293(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_77294 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_77294(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_77296 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_77296(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_77298 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_77298(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_77299 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_77299(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k77241,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__77247 = k77241;
var G__77247__$1 = (((G__77247 instanceof cljs.core.Keyword))?G__77247.fqn:null);
switch (G__77247__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k77241,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__77248){
var vec__77249 = p__77248;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77249,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77249,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__77240){
var self__ = this;
var G__77240__$1 = this;
return (new cljs.core.RecordIter((0),G__77240__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this77242,other77243){
var self__ = this;
var this77242__$1 = this;
return (((!((other77243 == null)))) && ((((this77242__$1.constructor === other77243.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77242__$1.status,other77243.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77242__$1.body,other77243.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77242__$1.status_text,other77243.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77242__$1.headers,other77243.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77242__$1.was_aborted,other77243.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this77242__$1.__extmap,other77243.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k77241){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k77241);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__77240){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__77265 = cljs.core.keyword_identical_QMARK_;
var expr__77266 = k__5352__auto__;
if(cljs.core.truth_((pred__77265.cljs$core$IFn$_invoke$arity$2 ? pred__77265.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__77266) : pred__77265.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__77266)))){
return (new ajax.protocols.Response(G__77240,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__77265.cljs$core$IFn$_invoke$arity$2 ? pred__77265.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__77266) : pred__77265.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__77266)))){
return (new ajax.protocols.Response(self__.status,G__77240,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__77265.cljs$core$IFn$_invoke$arity$2 ? pred__77265.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__77266) : pred__77265.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__77266)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__77240,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__77265.cljs$core$IFn$_invoke$arity$2 ? pred__77265.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__77266) : pred__77265.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__77266)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__77240,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__77265.cljs$core$IFn$_invoke$arity$2 ? pred__77265.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__77266) : pred__77265.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__77266)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__77240,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__77240),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__77240){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__77240,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__77246){
var extmap__5385__auto__ = (function (){var G__77275 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__77246,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__77246)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__77275);
} else {
return G__77275;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__77246),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__77246),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__77246),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__77246),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__77246),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
