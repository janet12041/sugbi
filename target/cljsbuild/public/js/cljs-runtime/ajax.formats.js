...
var G__77627 = request;
var G__77628 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__77627,G__77628) : ajax.formats.get_format.call(null,G__77627,G__77628));
} else {
...
return cljs.core.some((function (p1__77634_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__77634_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__77636){
var map__77637 = p__77636;
var map__77637__$1 = cljs.core.__destructure_map(map__77637);
var request = map__77637__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77637__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__77640 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__77640.cljs$core$IFn$_invoke$arity$1 ? fexpr__77640.cljs$core$IFn$_invoke$arity$1(response) : fexpr__77640.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__77650){
var map__77651 = p__77650;
var map__77651__$1 = cljs.core.__destructure_map(map__77651);
var request = map__77651__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77651__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__77648_SHARP_){
return ajax.formats.get_accept_entries(request,p1__77648_SHARP_);
