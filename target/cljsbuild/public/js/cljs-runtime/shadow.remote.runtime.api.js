...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_75155 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_75155(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_75157 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_75157(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_75158 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_75158(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_75159 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_75159(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_75167 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_75167(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_75168 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_75168(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__75143,callback){
var map__75144 = p__75143;
var map__75144__$1 = cljs.core.__destructure_map(map__75144);
var input = map__75144__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75144__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75144__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
