...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__78393 = cljs.core.second(format);
var G__78394 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__78393,G__78394) : ajax.easy.keyword_response_format_element.call(null,G__78393,G__78394));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__78395 = format;
var G__78395__$1 = (((G__78395 instanceof cljs.core.Keyword))?G__78395.fqn:null);
switch (G__78395__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__78396_SHARP_){
return ajax.easy.keyword_response_format_element(p1__78396_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__78397){
var map__78398 = p__78397;
var map__78398__$1 = cljs.core.__destructure_map(map__78398);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78398__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78398__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78398__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__78399){
var vec__78400 = p__78399;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78400,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78400,(1),null);
var fexpr__78403_78409 = (cljs.core.truth_(ok)?h:e);
(fexpr__78403_78409.cljs$core$IFn$_invoke$arity$1 ? fexpr__78403_78409.cljs$core$IFn$_invoke$arity$1(result) : fexpr__78403_78409.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__78404){
var map__78405 = p__78404;
var map__78405__$1 = cljs.core.__destructure_map(map__78405);
var opts = map__78405__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78405__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78405__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78405__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78405__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78405__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
