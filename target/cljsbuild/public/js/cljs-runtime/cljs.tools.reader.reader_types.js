...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_71982 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_71982(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_71983 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_71983(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_71984 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_71984(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_71994 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_71994(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_71995 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_71995(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_71996 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_71996(reader);
}
});
...
var G__72103 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__72104 = s.append(c);
c = G__72103;
s = G__72104;
continue;
}
