...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(tool_state,cljs.core.update,new cljs.core.Keyword(null,"timeline-zoom","timeline-zoom",-2049020154),(function (p1__73751_SHARP_){
if(cljs.core.truth_(inc_QMARK_)){
return (p1__73751_SHARP_ + (((curr < 0.1))?0.01:curr));
} else {
return (p1__73751_SHARP_ - (((curr <= 0.1))?0.01:(curr / (2))));
}
}));
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__73763_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__73763_SHARP_,new cljs.core.Keyword(null,"selected?","selected?",-742502788),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(indx),new cljs.core.Keyword(null,"indx","indx",1571035590).cljs$core$IFn$_invoke$arity$1(p1__73763_SHARP_)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"width","width",-384071477),(function (){var width = (new cljs.core.Keyword(null,"duration","duration",1444101068).cljs$core$IFn$_invoke$arity$1(p1__73763_SHARP_) * cljs.core.deref(mult));
return ((((width < (2)))?(2):width) | (0));
})(),new cljs.core.Keyword(null,"color","color",1011675173),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(indx),new cljs.core.Keyword(null,"indx","indx",1571035590).cljs$core$IFn$_invoke$arity$1(p1__73763_SHARP_)))?"#df691a":((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(p1__73763_SHARP_),new cljs.core.Keyword(null,"event","event",301435442)))?new cljs.core.Keyword(null,"blue","blue",-622100620):"#219653"))], 0));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__73769),re_frisk$ui$timeline$timeline_$_iter__73766(cljs.core.chunk_rest(s__73767__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__73769),null);
}
} else {
var x = cljs.core.first(s__73767__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"width","width",-384071477),(devi * mult__$1),new cljs.core.Keyword(null,"min-width","min-width",1926193728),(devi * mult__$1),new cljs.core.Keyword(null,"height","height",1025178622),(90),new cljs.core.Keyword(null,"border-left-width","border-left-width",2037218085),(1),new cljs.core.Keyword(null,"border-left-color","border-left-color",-1166146583),new cljs.core.Keyword(null,"gray","gray",1013268388),new cljs.core.Keyword(null,"border-left-style","border-left-style",65166675),new cljs.core.Keyword(null,"solid","solid",-2023773691),new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"gray","gray",1013268388),new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(10)], null)], null),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(((x * devi) | (0)))," ms"].join('')], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["timelime-time-item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x)].join('')], null)),re_frisk$ui$timeline$timeline_$_iter__73766(cljs.core.rest(s__73767__$2)));
}
} else {
return null;
}
...
})(),(function (){var iter__5523__auto__ = (function re_frisk$ui$timeline$timeline_$_iter__73777(s__73778){
return (new cljs.core.LazySeq(null,(function (){
var s__73778__$1 = s__73778;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__73778__$1);
if(temp__5804__auto__){
var s__73778__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__73778__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__73778__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__73780 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__73779 = (0);
while(true){
if((i__73779 < size__5522__auto__)){
var map__73781 = cljs.core._nth(c__5521__auto__,i__73779);
var map__73781__$1 = cljs.core.__destructure_map(map__73781);
var item = map__73781__$1;
var indx__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73781__$1,new cljs.core.Keyword(null,"indx","indx",1571035590));
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73781__$1,new cljs.core.Keyword(null,"color","color",1011675173));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73781__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var position = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73781__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
cljs.core.chunk_append(b__73780,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),["timeline-event-item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(indx__$1)].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__73779,map__73781,map__73781__$1,item,indx__$1,color,width,position,c__5521__auto__,size__5522__auto__,b__73780,s__73778__$2,temp__5804__auto__,mult__$1,devi,events,all_time,indx,mult,selected){
...
});})(i__73779,map__73781,map__73781__$1,item,indx__$1,color,width,position,c__5521__auto__,size__5522__auto__,b__73780,s__73778__$2,temp__5804__auto__,mult__$1,devi,events,all_time,indx,mult,selected))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__73780),re_frisk$ui$timeline$timeline_$_iter__73777(cljs.core.chunk_rest(s__73778__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__73780),null);
}
} else {
var map__73782 = cljs.core.first(s__73778__$2);
var map__73782__$1 = cljs.core.__destructure_map(map__73782);
var item = map__73782__$1;
var indx__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73782__$1,new cljs.core.Keyword(null,"indx","indx",1571035590));
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73782__$1,new cljs.core.Keyword(null,"color","color",1011675173));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73782__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var position = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73782__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),["timeline-event-item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(indx__$1)].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__73782,map__73782__$1,item,indx__$1,color,width,position,s__73778__$2,temp__5804__auto__,mult__$1,devi,events,all_time,indx,mult,selected){
return (function (event){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(tool_state,cljs.core.assoc,new cljs.core.Keyword(null,"selected-event","selected-event",898030638),item);
...
return event.preventDefault();
});})(map__73782,map__73782__$1,item,indx__$1,color,width,position,s__73778__$2,temp__5804__auto__,mult__$1,devi,events,all_time,indx,mult,selected))
,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"left","left",-399115937),((position * mult__$1) | (0)),new cljs.core.Keyword(null,"position","position",-2011731912),new cljs.core.Keyword(null,"absolute","absolute",1655386478),new cljs.core.Keyword(null,"width","width",-384071477),width,new cljs.core.Keyword(null,"min-width","min-width",1926193728),width,new cljs.core.Keyword(null,"top","top",-1856271961),(20),new cljs.core.Keyword(null,"height","height",1025178622),(70),new cljs.core.Keyword(null,"background-color","background-color",570434026),color,new cljs.core.Keyword(null,"opacity","opacity",397153780),0.5], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["timeline-event-item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(indx__$1)].join('')], null)),re_frisk$ui$timeline$timeline_$_iter__73777(cljs.core.rest(s__73778__$2)));
}
} else {
return null;
}
