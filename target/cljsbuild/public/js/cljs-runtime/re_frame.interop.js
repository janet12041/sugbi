...
return [(function (){var pred__66438 = cljs.core.instance_QMARK_;
var expr__66439 = reactive_val;
if(cljs.core.truth_((pred__66438.cljs$core$IFn$_invoke$arity$2 ? pred__66438.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__66439) : pred__66438.call(null,reagent.ratom.RAtom,expr__66439)))){
return "ra";
} else {
if(cljs.core.truth_((pred__66438.cljs$core$IFn$_invoke$arity$2 ? pred__66438.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__66439) : pred__66438.call(null,reagent.ratom.RCursor,expr__66439)))){
return "rc";
} else {
if(cljs.core.truth_((pred__66438.cljs$core$IFn$_invoke$arity$2 ? pred__66438.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__66439) : pred__66438.call(null,reagent.ratom.Reaction,expr__66439)))){
return "rx";
} else {
if(cljs.core.truth_((pred__66438.cljs$core$IFn$_invoke$arity$2 ? pred__66438.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__66439) : pred__66438.call(null,reagent.ratom.Track,expr__66439)))){
return "tr";
} else {
return "other";
}
