...
var G__56405 = o;
reagent.impl.template.goog$module$goog$object.set(G__56405,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__56423__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__56423 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__56424__i = 0, G__56424__a = new Array(arguments.length -  0);
while (G__56424__i < G__56424__a.length) {G__56424__a[G__56424__i] = arguments[G__56424__i + 0]; ++G__56424__i;}
  args = new cljs.core.IndexedSeq(G__56424__a,0,null);
} 
return G__56423__delegate.call(this,args);};
G__56423.cljs$lang$maxFixedArity = 0;
G__56423.cljs$lang$applyTo = (function (arglist__56425){
var args = cljs.core.seq(arglist__56425);
return G__56423__delegate(args);
});
G__56423.cljs$core$IFn$_invoke$arity$variadic = G__56423__delegate;
return G__56423;
})()
;
} else {
...
var G__56406 = o;
reagent.impl.template.goog$module$goog$object.set(G__56406,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__56426__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__56426 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__56427__i = 0, G__56427__a = new Array(arguments.length -  0);
while (G__56427__i < G__56427__a.length) {G__56427__a[G__56427__i] = arguments[G__56427__i + 0]; ++G__56427__i;}
  args = new cljs.core.IndexedSeq(G__56427__a,0,null);
} 
return G__56426__delegate.call(this,args);};
G__56426.cljs$lang$maxFixedArity = 0;
G__56426.cljs$lang$applyTo = (function (arglist__56428){
var args = cljs.core.seq(arglist__56428);
return G__56426__delegate(args);
});
G__56426.cljs$core$IFn$_invoke$arity$variadic = G__56426__delegate;
return G__56426;
})()
;
} else {
...
var G__56407 = props;
var G__56407__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56407,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__56407);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56407__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__56408 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56408,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__56408;
}
})(),id_class);
...
var G__56409 = (cljs.core.count(argv) - first_child);
switch (G__56409) {
case (0):
...
var vec__56410 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56410,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56410,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56410,(2),null);
...
var temp__5808__auto___56430 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___56430 == null)){
} else {
var key_56431 = temp__5808__auto___56430;
(jsprops.key = key_56431);
}
...
var temp__5808__auto___56432 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___56432 == null)){
} else {
var key_56433 = temp__5808__auto___56432;
(jsprops.key = key_56433);
}
...
var temp__5808__auto___56434 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___56434 == null)){
} else {
var key_56435 = temp__5808__auto___56434;
(jsprops.key = key_56435);
}
...
var temp__5808__auto___56436 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___56436 == null)){
} else {
var key_56437 = temp__5808__auto___56436;
(jsprops.key = key_56437);
}
...
var temp__5808__auto___56438 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___56438 == null)){
} else {
var key_56439 = temp__5808__auto___56438;
(jsprops.key = key_56439);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56413_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__56413_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__56414 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56414,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56414,(1),null);
...
break;
default:
var G__56441 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__56442 = compiler;
v = G__56441;
compiler = G__56442;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template56420 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template56420 = (function (opts,id,fn_to_element,parse_fn,meta56421){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta56421 = meta56421;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template56420.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_56422,meta56421__$1){
var self__ = this;
var _56422__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template56420(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta56421__$1));
}));

(reagent.impl.template.t_reagent$impl$template56420.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_56422){
var self__ = this;
var _56422__$1 = this;
return self__.meta56421;
}));

(reagent.impl.template.t_reagent$impl$template56420.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template56420.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template56420.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template56420.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template56420.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template56420.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta56421","meta56421",1863543723,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template56420.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template56420.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template56420");

(reagent.impl.template.t_reagent$impl$template56420.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template56420");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template56420.
 */
reagent.impl.template.__GT_t_reagent$impl$template56420 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template56420(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta56421){
return (new reagent.impl.template.t_reagent$impl$template56420(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta56421));
});

}

return (new reagent.impl.template.t_reagent$impl$template56420(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
