...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_57282 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_57282(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_57289 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_57289(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_57290 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_57290(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_57291 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_57291(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_57293 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_57293(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_57294 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_57294(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_57303 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_57303(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_57304 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_57304(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_57305 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_57305(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_57314 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_57314(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k57256,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57256,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__57264){
var vec__57265 = p__57264;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57265,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57265,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__57255){
var self__ = this;
var G__57255__$1 = this;
return (new cljs.core.RecordIter((0),G__57255__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57257,other57258){
var self__ = this;
var this57257__$1 = this;
return (((!((other57258 == null)))) && ((((this57257__$1.constructor === other57258.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57257__$1.status,other57258.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57257__$1.body,other57258.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57257__$1.status_text,other57258.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57257__$1.headers,other57258.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57257__$1.was_aborted,other57258.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57257__$1.__extmap,other57258.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k57256){
var self__ = this;
var this__5350__auto____$1 = this;
var G__57275 = k57256;
var G__57275__$1 = (((G__57275 instanceof cljs.core.Keyword))?G__57275.fqn:null);
switch (G__57275__$1) {
case "status":
case "body":
case "status-text":
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__57255){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__57277 = cljs.core.keyword_identical_QMARK_;
var expr__57278 = k__5352__auto__;
if(cljs.core.truth_((pred__57277.cljs$core$IFn$_invoke$arity$2 ? pred__57277.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__57278) : pred__57277.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__57278)))){
return (new ajax.protocols.Response(G__57255,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57277.cljs$core$IFn$_invoke$arity$2 ? pred__57277.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__57278) : pred__57277.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__57278)))){
return (new ajax.protocols.Response(self__.status,G__57255,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57277.cljs$core$IFn$_invoke$arity$2 ? pred__57277.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__57278) : pred__57277.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__57278)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__57255,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57277.cljs$core$IFn$_invoke$arity$2 ? pred__57277.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__57278) : pred__57277.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__57278)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__57255,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57277.cljs$core$IFn$_invoke$arity$2 ? pred__57277.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__57278) : pred__57277.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__57278)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__57255,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__57255),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__57255){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__57255,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__57259){
var extmap__5385__auto__ = (function (){var G__57281 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57259,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__57259)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57281);
} else {
return G__57281;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__57259),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__57259),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__57259),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__57259),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__57259),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
