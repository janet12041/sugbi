...
return [(function (){var pred__56554 = cljs.core.instance_QMARK_;
var expr__56555 = reactive_val;
if(cljs.core.truth_((pred__56554.cljs$core$IFn$_invoke$arity$2 ? pred__56554.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__56555) : pred__56554.call(null,reagent.ratom.RAtom,expr__56555)))){
return "ra";
} else {
if(cljs.core.truth_((pred__56554.cljs$core$IFn$_invoke$arity$2 ? pred__56554.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__56555) : pred__56554.call(null,reagent.ratom.RCursor,expr__56555)))){
return "rc";
} else {
if(cljs.core.truth_((pred__56554.cljs$core$IFn$_invoke$arity$2 ? pred__56554.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__56555) : pred__56554.call(null,reagent.ratom.Reaction,expr__56555)))){
return "rx";
} else {
if(cljs.core.truth_((pred__56554.cljs$core$IFn$_invoke$arity$2 ? pred__56554.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__56555) : pred__56554.call(null,reagent.ratom.Track,expr__56555)))){
return "tr";
} else {
return "other";
}
