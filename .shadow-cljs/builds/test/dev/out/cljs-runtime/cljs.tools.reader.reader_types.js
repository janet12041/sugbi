...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_57835 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_57835(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_57839 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_57839(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_57840 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_57840(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_57841 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_57841(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_57842 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_57842(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_57843 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_57843(reader);
}
});
...
var G__57849 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__57850 = s.append(c);
c = G__57849;
s = G__57850;
continue;
}
