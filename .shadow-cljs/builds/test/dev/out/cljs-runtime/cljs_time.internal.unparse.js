...
var periods__$1 = cljs.core.vec((function (){var G__58984 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58983_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__58983_SHARP_,(0),(3));
}),G__58984);
} else {
return G__58984;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__58996){
var vec__58997 = p__58996;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58997,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58997,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__59000 = pattern;
switch (G__59000) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__59000)].join('')));
...
return p1__59006_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__59007_SHARP_){
return p1__59007_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__59008_SHARP_){
return p1__59008_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__59009_SHARP_){
return p1__59009_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__59010_SHARP_){
return p1__59010_SHARP_.getHours();
});

break;
case "day":
return (function (p1__59011_SHARP_){
return p1__59011_SHARP_.getDate();
});

break;
case "month":
return (function (p1__59012_SHARP_){
return p1__59012_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__59013_SHARP_){
return p1__59013_SHARP_.getYear();
});
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__59015){
var vec__59016 = p__59015;
var seq__59017 = cljs.core.seq(vec__59016);
var first__59018 = cljs.core.first(seq__59017);
var seq__59017__$1 = cljs.core.next(seq__59017);
var key = first__59018;
var args = seq__59017__$1;
var G__59019 = key;
var G__59019__$1 = (((G__59019 instanceof cljs.core.Keyword))?G__59019.fqn:null);
switch (G__59019__$1) {
case "millis":
...
break;
case "ordinal-suffix":
var vec__59020 = (function (){var G__59023 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__59023) : syntax_list.call(null,G__59023));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59020,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__59019__$1)].join('')));
...
var d = value;
var G__59027 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__59028 = G__59027;
...
var unparser = first__59030;
var more = seq__59029__$1;
var s = "";
var d__$1 = d;
var G__59027__$1 = G__59027;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__59037 = G__59027__$1;
var seq__59038 = cljs.core.seq(vec__59037);
var first__59039 = cljs.core.first(seq__59038);
var seq__59038__$1 = cljs.core.next(seq__59038);
var unparser__$1 = first__59039;
var more__$1 = seq__59038__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__59040 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59040,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59040,(1),null);
var G__59081 = d__$3;
var G__59082 = more__$1;
var G__59083 = s__$3;
d__$1 = G__59081;
G__59027__$1 = G__59082;
s__$1 = G__59083;
continue;
}
break;
