...
var G__57513 = request;
var G__57514 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__57513,G__57514) : ajax.formats.get_format.call(null,G__57513,G__57514));
} else {
...
return cljs.core.some((function (p1__57515_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__57515_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__57516){
var map__57517 = p__57516;
var map__57517__$1 = cljs.core.__destructure_map(map__57517);
var request = map__57517__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57517__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__57519 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__57519.cljs$core$IFn$_invoke$arity$1 ? fexpr__57519.cljs$core$IFn$_invoke$arity$1(response) : fexpr__57519.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__57521){
var map__57522 = p__57521;
var map__57522__$1 = cljs.core.__destructure_map(map__57522);
var request = map__57522__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57522__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__57520_SHARP_){
return ajax.formats.get_accept_entries(request,p1__57520_SHARP_);
